...
import { ArrowLeft, ShoppingCart, MapPin, Store, Info, Minus, Plus, CheckCircle2 } from 'lucide-react';
            ...
            <div className="bg-white p-6 rounded-[2.5rem] shadow-sm flex items-center justify-between border border-gray-50">
              <div className="flex items-center gap-4">
                <img src={loja.logoUrl || 'https://images.pexels.com/photos/2132227/pexels-photo-2132227.jpeg?auto=compress&cs=tinysrgb&w=150'}
                  className="w-14 h-14 rounded-2xl object-cover border-2 border-gray-50" alt="Loja" />
                <div>
                  <span className="text-[9px] font-black uppercase text-[#55833d]">Vendedor Parceiro</span>
                  <h4 className="font-bold text-[#394158]">{loja.nomeLoja}</h4>
