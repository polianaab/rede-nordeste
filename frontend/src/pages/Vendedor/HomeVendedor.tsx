...
// --- DADOS DE NOTIFICAÇÕES (ADICIONADO PARA O MODAL) ---
                  ...
                  <>
                    ...
                    <div className="absolute top-14 right-0 w-[320px] md:w-[380px] bg-white rounded-[1rem] shadow-[0_10px_40px_rgba(0,0,0,0.15)] border border-gray-100 z-[70] animate-in slide-in-from-top-2 duration-200 overflow-hidden">
                      ...
                      <div className="max-h-[350px] overflow-y-auto no-scrollbar">
                        ...
                        )) : <div className="py-16 text-center opacity-20 flex flex-col items-center gap-2"><Bell size={40}/><p className="text-[10px] font-black uppercase italic">Sem novas notificações</p></div>}
                      </div>
                    </div>
                  </>
                )}
